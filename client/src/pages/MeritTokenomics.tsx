      ...
      <article className="space-y-12">
        ...
        <header className="text-center space-y-6 pb-8 border-b">
          ...
          <p className="font-serif text-xl italic text-muted-foreground">
            The Dao Bùa & The Path to Emptiness
          </p>
        ...
        <section className="space-y-4">
          <h2 className="font-serif text-2xl font-bold text-foreground" data-testid="heading-merit-token">
            The Intrinsic Merit Token: A Record, Not a Speculation
          </h2>
        ...
        {/* The Dao Bùa */}
        <section className="space-y-4">
          <h2 className="font-serif text-2xl font-bold text-foreground" data-testid="heading-dao-bua">
            The Dao Bùa: A Rocket and a Mirror
          </h2>
          <div className="font-serif text-base leading-relaxed text-foreground space-y-4 text-justify">
            <p>
        ...
        <section className="space-y-4">
          <h2 className="font-serif text-2xl font-bold text-foreground" data-testid="heading-spiritual-vision">
            The Spiritual Vision: Closing the Kalpa
          </h2>
          <div className="font-serif text-base leading-relaxed text-foreground space-y-4 text-justify">
            <p>
        ...
        <section className="space-y-4">
          <h2 className="font-serif text-2xl font-bold text-foreground" data-testid="heading-supreme-initiation">
            The Supreme Initiation: The Dao Merit
          </h2>
          <div className="font-serif text-base leading-relaxed text-foreground space-y-4 text-justify">
            <p>
        ...
        {/* Beyond the Three Trainings */}
        <section className="space-y-4">
          <h2 className="font-serif text-2xl font-bold text-foreground" data-testid="heading-tam-vo">
            Beyond the Three Trainings: Realizing Tam Vô
          </h2>
          <div className="font-serif text-base leading-relaxed text-foreground space-y-4 text-justify">
            <p>
